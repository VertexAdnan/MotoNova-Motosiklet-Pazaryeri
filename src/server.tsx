...
async function handlePageRequest(url: URL) {
    ...
    try {
        ...
        const fullTitle = `${process.env.APP_TITLE || "MotoNova"} | ${pageTitle}`;
        ...
        const clientEntryScriptPath = (await Bun.file("./dist/assets/src/entry-client.js").exists())
            ? "/assets/src/entry-client.js"
            : "/assets/entry-client.js";

        const clientScripts = `<script>
                                window.__PAGE_PATH__ = "${url.pathname}";
                            </script>
                            <script type="module" src="${clientEntryScriptPath}"></script>
                            ${!isProduction
                                ? `<script>
      ...
      <html lang="tr">
        <head>
          ...
          <meta name="description" content="${fullDescription}">
                    ...
                    <link href="https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700;800&family=Space+Grotesk:wght@600;700;800&display=swap" rel="stylesheet">
